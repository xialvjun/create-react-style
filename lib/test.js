...
// inline style
var ISC = index_1.createInlineStyle(index_1.Style.Consumer);
var inline_style = (React.createElement(ISC.div, { style: "display:grid" },
    React.createElement(ISC.div, { style: "grid-column:1/2;grid-row:1/3" },
        React.createElement(ISC.div, { style: "display:grid" },
            React.createElement(ISC.div, { style: "grid-column:1/2;grid-row:1/3" }, "1"),
            React.createElement(ISC.div, { style: "grid-column:2/3;grid-row:1/2" }, "2"),
            React.createElement(ISC.span, { style: "grid-column:2/3;grid-row:2/3" }, "3"),
            React.createElement(ISC.p, { style: "grid-column:1/3;grid-row:2/3" }, "4"))),
    React.createElement(ISC.div, { style: "grid-column:2/3;grid-row:1/2" }, "5"),
    React.createElement(ISC.div, { style: "grid-column:2/3;grid-row:2/3" }, "6"),
    React.createElement(ISC.div, { style: "grid-column:1/3;grid-row:2/3" }, "7")));
