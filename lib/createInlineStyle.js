    ...
    return new Proxy(Style, {
        get: function (target, p, receiver) {
            ...
            ISC = function (_a) {
                ...
                return (React.createElement(Style.Consumer, { css: css || style || inlineCss }, function (cn) { return (React.createElement(Tag, __assign({}, props, { className: className ? className + " " + cn : cn }))); }));
            };
            target[p] = ISC;
            return ISC;
        }
